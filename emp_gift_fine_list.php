...
echo "<th class='specalt'><b>gift_amount</b></th>";  
echo "<th class='specalt'><b>fine_amount</b></th>"; 
echo "<th class='specalt'><b>empID</b></th>"; 
echo "<th class='specalt'><b>transactionID</b></th>";
echo "<th class='specalt'><b>comments</b></th>";
echo "<th class='specalt'><b>date</b></th>";
echo "<th class='specalt' colspan=4><b>Actions</b></th>"; 
echo "</tr>";

$result = mysql_query("SELECT * FROM `campus_emp_gift_fine`") or trigger_error(mysql_error());

while($row = mysql_fetch_array($result)){ 
foreach($row as $key => $value) { $row[$key] = stripslashes($value); } 
echo "<tr>";  
echo "<td valign='top'>" . nl2br( $row['id']) . "</td>";  
echo "<td valign='top'>" . nl2br( $row['gift_amount']) . "</td>"; 
echo "<td valign='top'>" . nl2br( $row['fine_amount']) . "</td>"; 
...
echo "<td valign='top'><a href=emp_gift_fine_edit.php?id={$row['id']} class='button'>Edit</a></td><td><a onclick=\"return confirm('Are you sure you want to delete this Record?')\" class='button' href=#>Delete</a></td> ";
echo "</tr>"; 
} 
echo "</table>"; 
echo "<a href=emp_gift_fine_new.php class='button'>New Row</a>"; 
//}
//else
//{
