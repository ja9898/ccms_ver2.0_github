...
else if(isset($_POST['search-submit']) && $_POST['search-teacher-id2']!=0)
{
	...
	$result_regular_SD="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId='".$_POST['search-teacher-id2']."' 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0"; 
	...
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId='".$_POST['search-teacher-id2']."' 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=1"; 
	...
	$result_regular_SD_mon_tue_wed="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID,campus_schedule.classType 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId='".$_POST['search-teacher-id2']."' 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=1"; 
	...
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId='".$_POST['search-teacher-id2']."' 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=2"; 
	...
	$result_regular_SD_thur_fri_sat="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID,campus_schedule.classType 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId='".$_POST['search-teacher-id2']."' 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=2"; 
