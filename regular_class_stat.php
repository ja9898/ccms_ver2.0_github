...
<?php
getFilterSubmit();
echo " <a href='regular_class_stat_DEAD.php'>Regular Class Stat-DEAD</a> ";?></div>
<br>
</form>
</div>
<?
...
else if(isset($_POST['search-submit']) && ($_POST['search-teacher-id2']!=0 || $_POST['search-teacher-main']!=0))
{
	...
	$result_regular.=" and capmus_users.main_LeadId='".$_POST['search-teacher-main']."' ";}
	$result_regular.=" and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0"; 
	...
	//Following query is for REGULAR CLASS STAT and Standard Deviation calculations at the end
	$result_regular_SD="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,capmus_users.main_LeadId,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.id=campus_schedule.teacherID ";
	if($_POST['search-teacher-id2']!=0){
	$result_regular_SD.=" and capmus_users.LeadId='".$_POST['search-teacher-id2']."' ";}
	if($_POST['search-teacher-main']!=0){
	$result_regular_SD.="and capmus_users.main_LeadId='".$_POST['search-teacher-main']."' ";}
	$result_regular_SD.="and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0"; 
	$result_regular_SD.="  GROUP BY campus_schedule.teacherID,campus_schedule.std_status ORDER BY SUM(campus_schedule.dues) desc,campus_schedule.std_status asc,campus_schedule.teacherID desc";
	
	$result_regular=mysql_query($result_regular);
	$result_regular_SD=mysql_query($result_regular_SD);
	...
	if($_POST['search-teacher-main']!=0){
	$result_regular_mon_tue_wed.="and capmus_users.main_LeadId='".$_POST['search-teacher-main']."' ";}
	$result_regular_mon_tue_wed.="and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=1"; 
	...
	//Following query is for REGULAR CLASS STAT and Standard Deviation calculations at the end - MON,TUE,WED
	$result_regular_SD_mon_tue_wed="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,capmus_users.main_LeadId,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID,campus_schedule.classType 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.id=campus_schedule.teacherID ";
	if($_POST['search-teacher-id2']!=0){
	$result_regular_SD_mon_tue_wed.=" and capmus_users.LeadId='".$_POST['search-teacher-id2']."' ";}
	if($_POST['search-teacher-main']!=0){
	$result_regular_SD_mon_tue_wed.="and capmus_users.main_LeadId='".$_POST['search-teacher-main']."' ";}
	$result_regular_SD_mon_tue_wed.="and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=1"; 
	$result_regular_SD_mon_tue_wed.="  GROUP BY campus_schedule.teacherID,campus_schedule.std_status ORDER BY SUM(campus_schedule.dues) desc,campus_schedule.std_status asc,campus_schedule.teacherID desc";
	$result_regular_mon_tue_wed=mysql_query($result_regular_mon_tue_wed);
	$result_regular_SD_mon_tue_wed=mysql_query($result_regular_SD_mon_tue_wed);
	...
	if($_POST['search-teacher-main']!=0){
	$result_regular_thur_fri_sat.="and capmus_users.main_LeadId='".$_POST['search-teacher-main']."' ";}
	$result_regular_thur_fri_sat.="and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=2"; 
	...
	//Following query is for REGULAR CLASS STAT and Standard Deviation calculations at the end - THUR,FRI,SAT
	$result_regular_SD_thur_fri_sat="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,capmus_users.main_LeadId,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID,campus_schedule.classType 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.id=campus_schedule.teacherID ";
	if($_POST['search-teacher-id2']!=0){
	$result_regular_SD_thur_fri_sat.=" and capmus_users.LeadId='".$_POST['search-teacher-id2']."' ";}
	if($_POST['search-teacher-main']!=0){
	$result_regular_SD_thur_fri_sat.="and capmus_users.main_LeadId='".$_POST['search-teacher-main']."' ";}
	$result_regular_SD_thur_fri_sat.="and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType=2"; 
	$result_regular_SD_thur_fri_sat.="  GROUP BY campus_schedule.teacherID,campus_schedule.std_status ORDER BY SUM(campus_schedule.dues) desc,campus_schedule.std_status asc,campus_schedule.teacherID desc";
	$result_regular_thur_fri_sat=mysql_query($result_regular_thur_fri_sat);
	$result_regular_SD_thur_fri_sat=mysql_query($result_regular_SD_thur_fri_sat);
}

else{
	//OVERALL
	$result_regular="SELECT capmus_users.id,capmus_users.firstName,capmus_users.lastName,capmus_users.LeadId,capmus_users.main_LeadId,capmus_users.user_type,campus_schedule.id as sch_id,campus_schedule.dead_date,campus_schedule.std_status_old,campus_schedule.std_status,count(campus_schedule.studentID) as cnt_regular,campus_schedule.status,SUM(campus_schedule.dues) as dues,campus_schedule.dateBooked,campus_schedule.duedate,campus_schedule.comments_dead,campus_schedule.courseID,campus_schedule.teacherID 
	FROM capmus_users 
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId!=0 and capmus_users.main_LeadId!=0 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0"; 
	$result_regular.="  GROUP BY campus_schedule.teacherID,campus_schedule.std_status ORDER BY SUM(campus_schedule.dues) desc,campus_schedule.std_status asc,campus_schedule.teacherID desc";
	$result_regular=mysql_query($result_regular);
	...
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId!=0 and capmus_users.main_LeadId!=0 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType in (1,3,4,5,6,7)"; 
	$result_regular_mon_tue_wed.="  GROUP BY campus_schedule.teacherID,campus_schedule.std_status ORDER BY SUM(campus_schedule.dues) desc,campus_schedule.std_status asc,campus_schedule.teacherID desc";
	$result_regular_mon_tue_wed=mysql_query($result_regular_mon_tue_wed);
	...
	INNER JOIN campus_schedule 
	ON capmus_users.LeadId!=0 and capmus_users.main_LeadId!=0 
	and capmus_users.id=campus_schedule.teacherID and campus_schedule.std_status=2 and campus_schedule.std_status!=3 and campus_schedule.status=1 and campus_schedule.teacherID!=0 and campus_schedule.classType in (2,4,8,9,10)"; 
	$result_regular_thur_fri_sat.="  GROUP BY campus_schedule.teacherID,campus_schedule.std_status ORDER BY SUM(campus_schedule.dues) desc,campus_schedule.std_status asc,campus_schedule.teacherID desc";
	$result_regular_thur_fri_sat=mysql_query($result_regular_thur_fri_sat);
...
echo "<th class='specalt'><b>MAIN TeamLead</b></th>";   
...
echo "<tr>";
	...
	echo "<td valign='top'> </td>";
	echo "<td valign='top'> </td>";
	echo "<th class='specalt' style='color:blue;'><b>Regular(MON,TUE,WED)</b></th>";
	echo "<td valign='top'> </td>";
	echo "<td valign='top'> </td>";
echo "</tr>"; 
//FOR CAD-CAD Array
...
echo "<td valign='top'>" . showUser( nl2br( $row_regular_mon_tue_wed['main_LeadId'])) . "</td>";
...
echo "<tr>";
	...
	echo "<td valign='top'> </td>";
	echo "<td valign='top'> </td>";
	echo "<th class='specalt' style='color:blue;'><b>Regular(THUR,FRI,SAT)</b></th>";
	echo "<td valign='top'> </td>";
	echo "<td valign='top'> </td>";
echo "</tr>"; 
//FOR CAD
...
echo "<tr>";
echo "<td valign='top'>" . $serial . "</td>";
echo "<td valign='top'>" . showUser( nl2br( $row_regular_thur_fri_sat['main_LeadId'])) . "</td>";
...
echo "<tr>";
echo "<td valign='top'>" . $serial . "</td>";
echo "<td valign='top'>" . showUser( nl2br( $row_regular['main_LeadId'])) . "</td>";
...
//********>>>>>>>>FOLLOWING IS RELATED TO THE Standard Deviation<<<<<<<<********
//Get 1 cad to usd rate from db
$sql_1cad_to_dollar_rate_USDval="SELECT * FROM campus_currency WHERE id = 433";
$row_1cad_to_dollar_rate_USDval = mysql_fetch_array(mysql_query($sql_1cad_to_dollar_rate_USDval));
$row_1cad_to_dollar_rate_USDval['1_cad_to_usd'];
...
//Table for Mean business per slot
echo "<table  border=0 id='' cellspacing=0 >"; 
	echo "<tr>";
...
while(($row_regular_SD = mysql_fetch_array($result_regular_SD)))
{ 
//CAD
...
$x_xbar_square=pow(($total_amount_per_teacher-$mean_teacher),2);
$x_xbar_square_array[$row_regular_SD['sch_id']] = $x_xbar_square;
//USD
...
//CAD
$x_xbar_square_array_sum = nl2br( array_sum($x_xbar_square_array));
//USD
$x_xbar_square_array_sum_usd = nl2br( array_sum($x_xbar_square_array_usd));
//CAD
$square_root = sqrt($x_xbar_square_array_sum);
//USD
$square_root_usd = sqrt($x_xbar_square_array_sum_usd);
echo "<table  border=0 id='' cellspacing=0 >"; 
	echo "<tr>";
