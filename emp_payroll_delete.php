...
$row = mysql_fetch_array( mysql_query(" SELECT * FROM campus_payroll WHERE id='$id' ")) or die(mysql_error());
...
///////////////////////////////////////////////////////
mysql_query("DELETE FROM `campus_payroll` WHERE `id` = '$id' ") ; 
getMessages('delete','emp_payroll_list.php');
