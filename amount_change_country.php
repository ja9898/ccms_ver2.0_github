...
echo "<th class='specalt'><b>DUES Converted</b></th>"; 
...
$query2="select `campus_students`.id,`campus_students`.email,`campus_students`.mobile,`campus_students`.phone,`campus_students`.landline,`campus_students`.countryID from `campus_students` where campus_students.countryID=4 and campus_students.id=".$row['studentID'];
...
if($rows2['countryID']==4)
{
$resulted_amt_point95_into_amt = $row['dues'] * 0.95;
echo "<td valign='top'>" . $resulted_amt_point95_into_amt . "</td>";
}
else
echo "<td valign='top'>NONE</td>";
...
//Multiplying the amount(dues) with 0.95  of Australian Students Only under campus_schedule
$update_time="UPDATE campus_schedule 
SET campus_schedule.dues='".$resulted_amt_point95_into_amt."' 
