...
echo "<th class='specalt'><b>Skype Text</b></th>";
...
{
	$result = getResultResource('campus_schedule',$_POST,"status=1 and campus_schedule.std_status!='3' and agentId='".$_SESSION['userId_bas']."'","",",campus_students.firstName as name,campus_students.std_status as std_status ",""," left JOIN campus_students ON campus_schedule.studentID=campus_students.id  "," order by name asc",'campus_schedule.std_status as statussch,campus_schedule.startTime'); 
}
else if(isset($_POST['search-submit']) && $_POST['stdStatus']!="" && $_POST['stdStatus']!=0)
{
	...
	if($_SESSION['userId']==1 || $_SESSION['userId']==48 || $_SESSION['userId']==159 || $_SESSION['userId']==886 || $_SESSION['userId']==411 || $_SESSION['userId']==890 || $_SESSION['userId']==889 || $_SESSION['userId']==1927)
	{
...
if($_SESSION['userId']==159 || $_SESSION['userId']==48 || $_SESSION['userId']==411 || $_SESSION['userId']==886 || $_SESSION['userId']==890 || $_SESSION['userId']==889 || $_SESSION['userId']==1927)
{
echo "<td valign='top'><a class=button href=book_scheduler_edit_skype_ver2.php?id={$row['id']}>Edit</a></td>";
}
else
{
