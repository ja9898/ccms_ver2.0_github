...
$_title['book_scheduler_dead.php']="DC Schedule";
$_title['logging_list.php']="List Logging";
$_title['book_scheduler_dead_confirmation.php']="DC Confirmation List";
$_title['book_scheduler_dead_message.php']="DC Confirmation Message";
...
$_title['pending_report_new_with_balance.php']="Pending with Balance";
...
$_title['biometric_list_HR_view.php']="Biometric List HR";
...
$_permission[15]=array("Error 404","Extension List","Pend Rpt Ver4-overall","Email Student List","Month Start End Report TTL Edit","Month Start End Report TTL","Month Start End Report","Ticket Close","Ticket List","Payment Record Report Delete","Transaction Student Report Detailed","MANAGE SCHEDULE PARENT","Edit Students","DC Confirmation Message","DC Schedule","List App-GM","TL Confirm List","Unfreeze Schedule","Freeze schedule","Freeze List","Leave App New","Short Leave App New","DC Confirmation List","Parent List","Parent New","Parent Edit","Parent Assign","Meeting Link List","Meeting Link New","Meeting Link Edit","Short List App-TL","Teacher TL Report OLD","Chat Panel","Chat Panel to chat","List App-TL","Transaction new next next month","New Students","Regular Class Stat","Notice Teachers Manual","SOP discipline","SOP","Memo referral/commision","Comments General","Notice ceo meeting time","Memo","Notice documents","Notices","Leave Policy","Policies","Pending report-overall","Transaction new next month","Transaction List Due Payments","Pending report","Payment Record Report","List Due Payments","New Payments","Total Payments","DC Confirmation Message","Present/Absent Report","Daily Schedule Ver2","Teacher TL Report","Dashboard","Daily Schedule","List Schedule","Change Password","Class Attendance","Manage Schedule","List Students","Student Classes","Edit Schedule","New Schedule","List Teacher Timings","Edit Teacher Timings","List Teacher's Course","Trial Report","Trial Confirmation List","Confirm Schedule","Transaction Details");

//////////////MAIN Agent Team Lead Permissions///////////////////	///NEWLY ADDED	//06-11-2013
$_permission[16]=array("Error 404","TL Confirm List","Unfreeze Schedule","Freeze List","Leave App New","Short Leave App New","Chat Panel","Chat Panel to chat","New Schedule-Group","Notice Teachers Manual","SOP discipline","SOP","Comments General","Notice ceo meeting time","Memo","Notice documents","Notices","Leave Policy","Policies","Payment Record Report","Agent TL Report","List Students","New Students","Error 404","Dashboard","List Schedule","Manage Schedule","New Schedule","Change Password","List Callbacks","New Callback","Edit Callbacks","Trial Confirmation List","Confirm Schedule","Edit Schedule","DC Confirmation Message"/*,"DC Schedule"*/,"Transaction Details","Edit Skype IDs","New Skype IDs"/*,"List Skype IDs"*/);
                ...
                <div class="head_memberinfo">
                    ...
                    <span class='memberinfo_span2'>
						...
						<a href="chat_panel_to_chat.php"><b> <? echo $row_count_non_read_msgs;  ?></b> Private Message recieved 
											...
											<?	
echo "<table width='50%'  border=0 id='table_liquid' cellspacing=0 >"; 
echo "<tr>";
