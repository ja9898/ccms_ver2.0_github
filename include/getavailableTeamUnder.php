...
//{
	...
	$usertype_teamlead_id=intval($_GET['usertype_teamlead_id']);
//}
//echo $usertype_teamlead_id."<br><br><br><br>";
//global $_LISTTEAM;

if($usertype_teamlead==8) // CHECKING TEACHER TEAM LEADS
{

$availableTeam_LeadUnder_query_A=("SELECT * FROM capmus_users WHERE user_type=3 and LeadId=0 order by firstName ASC"); //Query for Available Teachers
$availableTeam_LeadUnder_query_NA=("SELECT * FROM capmus_users WHERE user_type=3 and LeadId='$usertype_teamlead_id' order by firstName ASC"); //Query for Not Available/Occupied Teachers
...
<!--</div>-->
<div id="field"><input type="hidden" name="team_lead_id" value=<?php echo $usertype_teamlead_id; ?> /></div>
