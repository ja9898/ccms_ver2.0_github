...
<div id="label">Class Plan:</div><div id="field"><?php echo getList($_POST['classType'],'classType','plan','Select Class Type','availableTeacher_no_subject','availableTeachers');?></div> 
