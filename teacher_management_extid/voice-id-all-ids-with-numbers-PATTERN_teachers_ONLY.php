...
SELECT * 
FROM capmus_users 
WHERE `status`=1 AND voice_id!='' AND  `user_type`=3";
 ...
 */
	...
	if(trim($row_teachers_agents['voice_id']) != ''){
		...
		$tofile1 .= "[".$row_teachers_agents['voice_id']."]\r\n";
		$tofile1 .= "deny=0.0.0.0/0.0.0.0\r\n";
		$tofile1 .= "secret=".$row_teachers_agents['v_password']."\r\n";
		...
		$tofile1 .= "port=32300\r\n";
		$tofile1 .= "qualify=yes\r\n";
			$tofile1 .= "dial=SIP/".$row_teachers_agents['voice_id']."\r\n";
		$tofile1 .= "mailbox=".$row_teachers_agents['voice_id']."@device\r\n";
		$tofile1 .= "permit=0.0.0.0/0.0.0.0\r\n";
		$tofile1 .= "trustrpid=yes\r\n";
		$tofile1 .= "sendrpid=no\r\n";
		$tofile1 .= "qualifyfreq=64\r\n";
		$tofile1 .= "transport=udp,tcp,tls,ws\r\n";
		$tofile1 .= "encryption=no\r\n";
		$tofile1 .= "callerid= <".$row_teachers_agents['voice_id'].">\r\n";
	...
	$myFile = "voice-id-all-ids-with-numbers-PATTERN_teachers".date('dMYHis')."($from_date to $to_date).txt";
