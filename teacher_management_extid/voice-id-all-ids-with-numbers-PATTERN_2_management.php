 ...
 */
	...
	if(trim($row_management['voice_id']) != ''){	
		...
		$tofile1 .= "exten => ".$row_management['voice_id'].",1,Set(__RINGTIMER=$"."{IF($[$"."{DB(AMPUSER/".$row_management['voice_id']."/ringtimer)} > 0]?$"."{DB(AMPUSER/".$row_management['voice_id']."/ringtimer)}:$"."{RINGTIMER_DEFAULT})})\r\n";
		$tofile1 .= "exten => ".$row_management['voice_id'].",n,Macro(exten-vm,novm,".$row_management['voice_id'].",0,0,0)\r\n";
		$tofile1 .= "exten => ".$row_management['voice_id'].",n(dest),Set(__PICKUPMARK=)\r\n";
		$tofile1 .= "exten => ".$row_management['voice_id'].",n,Goto($"."{IVR_CONTEXT},return,1)\r\n";
		$tofile1 .= "exten => ".$row_management['voice_id'].",n,Goto(from-internal,".$row_management['voice_id'].",1)\r\n";
		$tofile1 .= "exten => ".$row_management['voice_id'].",hint,SIP/".$row_management['voice_id']."@voip&Custom:DND".$row_management['voice_id'].",CustomPresence:".$row_management['voice_id']."\r\n";
		$tofile1 .= "\r\n";		
	...
	$myFile = "voice-id-all-ids-with-numbers-PATTERN_2_management".date('dMYHis')."($from_date to $to_date).txt";
