...
if(isset($_POST['sender']))
{
	if(!empty($_POST['accounts_amount']) && isset($_POST['accounts_chk_box_id']))
	{
		...
		if($_POST['campus']==1 && $_POST['schedule_id']!=0 && $_POST['schedule_id']!="")
		{
			...
			$update_schedule_dates=mysql_query("UPDATE campus_schedule_23sep2017_backup SET duedate='".$systemdate."' , paydate='".$systemdate."' WHERE id='".$schedule_id."'  ") or trigger_error(mysql_error());
			$update_accounts_amount = mysql_query("UPDATE campus_transaction_23sep2017_backup SET accounts_chk = '1' , date='".$systemdate."' , dateRecieved='".$systemdate."' , amount_usd_simple='".$accounts_amount."' , accounts_comment = '".$accounts_comment."' , amount='".$accounts_amount_CAD."' WHERE id='".$accounts_chk_box_id."' ") or trigger_error(mysql_error());
			getMessages('edit','payment_record_report_test.php');
		}
		else
		{
			$update_accounts_amount = mysql_query("UPDATE campus_transaction_23sep2017_backup SET accounts_chk = '1' , date='".prepareDate($received_date_manual)."' , amount_usd_simple='".$accounts_amount."' , accounts_comment = '".$accounts_comment."' , amount='".$accounts_amount_CAD."' WHERE id='".$accounts_chk_box_id."' ") or trigger_error(mysql_error());
			getMessages('edit','payment_record_report_test.php');
...
if(isset($_POST['submit']))
{
 ...
 //NO CONDITION ON REGULAR STUDENTS TRANSACTION, all include, regular, dead, freeze
 	$sql=" SELECT campus_schedule_23sep2017_backup.id,campus_schedule_23sep2017_backup.duedate as due_date,
	day(campus_schedule_23sep2017_backup.duedate) AS dayz,month(campus_schedule_23sep2017_backup.duedate) AS month,
	campus_schedule_23sep2017_backup.dues as amount,campus_schedule_23sep2017_backup.studentID,campus_schedule_23sep2017_backup.courseID,campus_schedule_23sep2017_backup.classType,campus_schedule_23sep2017_backup.`status`,
	campus_schedule_23sep2017_backup.std_status,campus_schedule_23sep2017_backup.std_status_old,campus_schedule_23sep2017_backup.startTime,
	campus_transaction_23sep2017_backup.id as tran_id,campus_transaction_23sep2017_backup.transactionID,campus_transaction_23sep2017_backup.date as date_rec_cam_tran,campus_transaction_23sep2017_backup.studentID,
	campus_transaction_23sep2017_backup.amount as amounttran,campus_transaction_23sep2017_backup.operator as tran_op,campus_transaction_23sep2017_backup.courseID as tran_cid,campus_transaction_23sep2017_backup.classType as tran_ctid,
	campus_transaction_23sep2017_backup.dateRecieved as maxdate_rec,campus_transaction_23sep2017_backup.startTime,campus_transaction_23sep2017_backup.schedule_id,campus_transaction_23sep2017_backup.comments,campus_transaction_23sep2017_backup.teacherID,
	campus_transaction_23sep2017_backup.method,campus_transaction_23sep2017_backup.method_array,campus_transaction_23sep2017_backup.LeadId,campus_transaction_23sep2017_backup.main_LeadId,
	campus_transaction_23sep2017_backup.sender_name,campus_transaction_23sep2017_backup.email, 
	campus_transaction_23sep2017_backup.currency_array,campus_transaction_23sep2017_backup.amount_gbp as amounttran_gbp, 
	campus_transaction_23sep2017_backup.amount_original as amounttran_original,campus_transaction_23sep2017_backup.campus,
	campus_transaction_23sep2017_backup.agent_id,campus_transaction_23sep2017_backup.agentLeadId,campus_transaction_23sep2017_backup.main_agentLeadId,
	campus_transaction_23sep2017_backup.accounts_chk,campus_transaction_23sep2017_backup.accounts_comment,
	campus_transaction_23sep2017_backup.agent_comm,campus_transaction_23sep2017_backup.teacher_comm,campus_transaction_23sep2017_backup.cardSave_ccv_code,
	campus_transaction_23sep2017_backup.amount_usd_simple,
	campus_transaction_23sep2017_backup.datetime_now_accounts,campus_transaction_23sep2017_backup.bank_payment_image_filepath,
	campus_transaction_23sep2017_backup.discount_tran,campus_transaction_23sep2017_backup.amount_original_deducted 
	FROM campus_schedule_23sep2017_backup 
	INNER JOIN campus_transaction_23sep2017_backup 
	ON campus_schedule_23sep2017_backup.studentID=campus_transaction_23sep2017_backup.studentID and campus_schedule_23sep2017_backup.id=campus_transaction_23sep2017_backup.schedule_id 
	and campus_schedule_23sep2017_backup.`status` =1  and 
	campus_transaction_23sep2017_backup.date BETWEEN '".prepareDate($_POST['fromDate'])."' AND '".prepareDate($_POST['toDate'])."' and campus_transaction_23sep2017_backup.date!='' ";
	if(isset($_POST['submit']) && $_POST['search-teacher-id2']!=0)
	{
		$sql.=" and campus_transaction_23sep2017_backup.LeadId='".$_POST['search-teacher-id2']."' ";
	}
	if(isset($_POST['submit']) && $_POST['search-teacher-main']!=0)
	{
		$sql.=" and campus_transaction_23sep2017_backup.main_LeadId='".$_POST['search-teacher-main']."' ";
	}
	if(isset($_POST['submit']) && $_POST['paymentMode']!=0)
	{
		$sql.=" and campus_transaction_23sep2017_backup.method_array='".$_POST['paymentMode']."' ";
	}
	if(isset($_POST['submit']) && $_POST['search-teacher-id']!=0)
	{
		$sql.=" and campus_transaction_23sep2017_backup.teacherID='".$_POST['search-teacher-id']."' ";
	}
	if($_POST['recurr_signup']!=0)
	{
		if($_POST['recurr_signup']==2)
		$sql.=" and campus_transaction_23sep2017_backup.campus=1 ";
		if($_POST['recurr_signup']==1)
		$sql.=" and campus_transaction_23sep2017_backup.campus IS NULL ";
	}
	...
	{
		$sql.=" and campus_transaction_23sep2017_backup.operator='".$_POST['search-agent-id2']."' ";
	}
}
}
?>
...
if(isset($_POST['submit']))
{
	...
	$countmonthsql="select amount as amounttran_not_main,date,dateRecieved,operator,id FROM campus_transaction_23sep2017_backup where date BETWEEN '".nl2br(prepareDate($_POST['fromDate']))."' AND '".nl2br(prepareDate($_POST['toDate']))."' and studentID=".$row['studentID']." and schedule_id=".$row['id']." and id=".$row['tran_id']." "; 
	...
	//$maxdate_rec="SELECT MAX(dateRecieved) as maxdate_rec,MAX(date) as date_rec_cam_tran FROM campus_transaction_23sep2017_backup where studentID=".$row['studentID']." and courseID=".$row['courseID']." and classType=".$row['classType']." and startTime='".$row['startTime']."'"; 
	////$maxdate_rec="SELECT MAX(dateRecieved) as maxdate_rec,MAX(date) as date_rec_cam_tran FROM campus_transaction_23sep2017_backup where studentID=".$row['studentID']." and schedule_id=".$row['schedule_id']." "; 
