...
/*Getting parentId from pending report-Overall AND setting $_POST['search-submit']
and also setting $_POST['search-parent-id'] */
$parentId = $_GET['parentId'];
if($parentId!='' && $parentId!=0)
{
	$_POST['search-submit']=1;
	$_POST['search-parent-id']=$parentId;
}
else
{
	$_POST['search-submit']=0;
	$_POST['search-parent-id']=0;
}
/**/
?>
<div id="filter">
...
echo "<b><div style='float:left; color:orange'>Parent : ".getparentname($parentId)." &nbsp;&nbsp;&nbsp;</div><br></b>";
