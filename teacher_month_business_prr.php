...
//getStudentFilter();
?>
&nbsp;&nbsp;<?php if($_SESSION['userType']==1 || $_SESSION['userType']==3 || $_SESSION['userType']==6 || $_SESSION['userType']==2) { echo getInput(stripslashes($_POST['fromDate']),'fromDate','class=flexy_datepicker_input');?>&nbsp;&nbsp;
<?php echo getInput(stripslashes($_POST['toDate']),'toDate','class=flexy_datepicker_input'); }?>&nbsp;&nbsp;
<?php if($_SESSION['userType']==1 || $_SESSION['userType']==15 || $_SESSION['userType']==6 || $_SESSION['userType']==8 || $_SESSION['userType']==2) { getTeacherFilterLead_main(); getTeacherFilterLead(); getTeacherFilter();  } ?>
&nbsp;&nbsp;
<? if($_SESSION['userType']==1 || $_SESSION['userType']==3 || $_SESSION['userType']==6 || $_SESSION['userType']==2) { ?> 
...
while($row_sql_business_first = mysql_fetch_array($sql_business_result_first))
{
	...
	if($_SESSION['userType']==1 || $_SESSION['userType']==6 || $_SESSION['userType']==2){//$_POST['search-teacher-id']!=0
...
echo "<td valign='top'>" . $basic_salary = $row_basic_salary['basic_salary'] . "</td>";
//Basic salary array
$basic_salary_ary[$row_sql_business_first['tran_id']]=$basic_salary;
...
echo "</tr>"; 
	...
	//basic salary sum
	echo "<td valign='top' style='color:green; font-weight:bold'><b>Rs: " . array_sum($basic_salary_ary) . "</td>";  
...
if($_SESSION['userType']==1 || $_SESSION['userType']==6 || $_SESSION['userType']==2){
