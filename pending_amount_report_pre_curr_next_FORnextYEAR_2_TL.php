...
echo "<tr>";  
 echo "<td valign='top'>Sum </td>";  
echo "<td valign='top'><b>$" . nl2br( array_sum($total_sum_teamlead_each_curr_1to10)) . "</td>"; 
...
//CURRENT MONTH		//11th till 20th
//*******************************************************************************************************************************************************************//
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Following is related to the CURRENT MONTH DUES CALCULATIONS <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

echo "<div align='center' style='color:red; font-size:16px'>CURRENT MONTH PENDINGS(11th till 20th)</div>";
echo "<table border=0 id='table_liquid' cellspacing=0  >"; 
echo "<tr>"; 
echo "<th class='specalt' colspan=3 align='center' style='font-size:18px; color:Blue'>".date('M')."</th>"; 
echo "</tr>";
...
//Array for LOOP FOR TEAMLEADS
$sum_teamlead_each_curr_11to20=array();
$total_sum_teamlead_each_curr_11to20=array();
$sum_teamlead_each_curr_11to20_USD=array();
$total_sum_teamlead_each_curr_11to20_USD=array();
...
$counter_for_teamlead_sum = 1;
foreach($_POST['stateunderID'] as $team_under_index){		//LOOP FOR TEAMLEADS curr month		//START				
					/* echo "CURRENT 1 SEPARATE - NOW 11th to 20th";
					echo "<br>"; */
					$sql=" Select capmus_users.id as users_id,capmus_users.LeadId,
					campus_schedule.id,
					campus_schedule.duedate as due_date,
					...
					capmus_users.id=campus_schedule.teacherID and campus_schedule.teacherID!=0 and 
					campus_schedule.`status` =1 and campus_schedule.std_status=2 and 
					day(campus_schedule.paydate) BETWEEN '11' AND '20' 
					order by paydayz DESC";
	...
	echo "<tr>";  
	echo "<td valign='top' style='color:black; font-weight:bold'>".showUser( nl2br( $team_under_index))."</td>";
	echo "<td valign='top'>".$sum_teamlead_each_curr_11to20[$counter_for_teamlead_sum] = array_sum($pending)."</td>";
	echo "<td valign='top'>".$sum_teamlead_each_curr_11to20_USD[$counter_for_teamlead_sum] = array_sum($pending_usd_convert) ."</td>";
	$sum_teamlead_each_curr_11to20[$counter_for_teamlead_sum] = array_sum($pending);

	$total_sum_teamlead_each_curr_11to20[$counter_for_teamlead_sum] = $sum_teamlead_each_curr_11to20[$counter_for_teamlead_sum];
	$total_sum_teamlead_each_curr_11to20_USD[$counter_for_teamlead_sum] = $sum_teamlead_each_curr_11to20_USD[$counter_for_teamlead_sum];
	$counter_for_teamlead_sum = $counter_for_teamlead_sum + 1;
	unset($sum_teamlead_each_curr_11to20);
	unset($pending);
	unset($sum_teamlead_each_curr_11to20_USD);
	unset($pending_usd_convert);
	echo "</tr>";
...
echo "<tr>";  
 echo "<td valign='top'>Sum </td>";  
echo "<td valign='top'><b>$" . nl2br( array_sum($total_sum_teamlead_each_curr_11to20)) . "</td>"; 
echo "<td valign='top' style='color:green; font-weight:bold'><b>$" . array_sum($total_sum_teamlead_each_curr_11to20_USD) . "</td>"; 
echo "</tr>";
echo "</table>";
...
//CURRENT MONTH		//21st till 29/30/31st
//*******************************************************************************************************************************************************************//
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> Following is related to the CURRENT MONTH DUES CALCULATIONS <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

echo "<div align='center' style='color:red; font-size:16px'>CURRENT MONTH PENDINGS(21st till 29/30/31st)</div>";
echo "<table border=0 id='table_liquid' cellspacing=0  >"; 
echo "<tr>"; 
echo "<th class='specalt' colspan=3 align='center' style='font-size:18px; color:Blue'>".date('M')."</th>"; 
echo "</tr>";
...
//Array for LOOP FOR TEAMLEADS
$sum_teamlead_each_curr_21to31=array();
$total_sum_teamlead_each_curr_21to31=array();
$sum_teamlead_each_curr_21to31_USD=array();
$total_sum_teamlead_each_curr_21to31_USD=array();
...
$counter_for_teamlead_sum = 1;
foreach($_POST['stateunderID'] as $team_under_index){		//LOOP FOR TEAMLEADS curr month		//START
					/* echo "CURRENT 1 SEPARATE - NOW 21st to 31st";
					echo "<br>"; */
					$sql=" Select capmus_users.id as users_id,capmus_users.LeadId,
					campus_schedule.id,
					campus_schedule.duedate as due_date,
					...
					capmus_users.id=campus_schedule.teacherID and campus_schedule.teacherID!=0 and 
					campus_schedule.`status` =1 and campus_schedule.std_status=2 and 
					day(campus_schedule.paydate) BETWEEN '21' AND '31' 
					order by paydayz DESC";
	...
	echo "<tr>";  
	echo "<td valign='top' style='color:black; font-weight:bold'>".showUser( nl2br( $team_under_index))."</td>";
	echo "<td valign='top'>".$sum_teamlead_each_curr_21to31[$counter_for_teamlead_sum] = array_sum($pending)."</td>";
	echo "<td valign='top'>".$sum_teamlead_each_curr_21to31_USD[$counter_for_teamlead_sum] = array_sum($pending_usd_convert) ."</td>";
	$sum_teamlead_each_curr_21to31[$counter_for_teamlead_sum] = array_sum($pending);
	$total_sum_teamlead_each_curr_21to31[$counter_for_teamlead_sum] = $sum_teamlead_each_curr_21to31[$counter_for_teamlead_sum];
	$total_sum_teamlead_each_curr_21to31_USD[$counter_for_teamlead_sum] = $sum_teamlead_each_curr_21to31_USD[$counter_for_teamlead_sum];
	$counter_for_teamlead_sum = $counter_for_teamlead_sum + 1;
	unset($sum_teamlead_each_curr_21to31);
	unset($pending);
	unset($sum_teamlead_each_curr_21to31_USD);
	unset($pending_usd_convert);
	echo "</tr>";
...
echo "<tr>";  
 echo "<td valign='top'>Sum </td>";  
echo "<td valign='top'><b>$" . nl2br( array_sum($total_sum_teamlead_each_curr_21to31)) . "</td>"; 
echo "<td valign='top' style='color:green; font-weight:bold'><b>$" . array_sum($total_sum_teamlead_each_curr_21to31_USD) . "</td>"; 
echo "</tr>";
echo "</table>";
