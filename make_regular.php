...
<div id="label">Original Amount:</div><div id="field"><input type='text' id='amount_original' name='amount_original' onchange="javascript : calculate_currency_conversion();" required/> </div>
...
<div id="label">Discount:</div><div id="field"><input required type='text' name='discount'/> </div>
