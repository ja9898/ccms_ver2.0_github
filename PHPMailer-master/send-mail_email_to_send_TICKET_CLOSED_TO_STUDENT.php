...
echo $student_ticket_email = $_POST['student_ticket_email'];
...
$mail->FromName = "Ticket Closed by Shift Manager - CCMS YourCloudCampus";
...
$mail->addAddress($student_ticket_email,"User 2");
$mail->addAddress($ttl_ticket_email,"User 3");
$mail->addAddress($mttl_ticket_email,"User 4");
 
$mail->Subject = "Ticket Closed - YourCloudCampus";
$mail->Body = "<div align='center'><b>TICKET CLOSED</b></div>   <br><br>".$letter_format;
