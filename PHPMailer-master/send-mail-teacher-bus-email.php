...
$mail->FromName = "CCMS-Teacher Business Email";
 
$mail->addAddress("junaid9898@yahoo.com","User 1");
//$mail->addAddress("shehzad@yourcloudcampus.com","User 2");
//$mail->addAddress("taimur@yourcloudcampus.com","User 3");
$mail->addAddress("faheem@yourcloudcampus.com","User 4");
//$mail->addAddress("junaid.abbas86@hotmail.com","User 2");
 
//$mail->addCC("junaid9898@yahoo.com","User 3");
//$mail->addBCC("user.4@in.com","User 4");
 
$mail->Subject = "Teacher Business Email - FROM LOCALHOST - TESTING";
