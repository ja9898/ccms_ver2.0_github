...
// $mail->Port = 587;
// $mail->SMTPSecure = 'tls';
echo $paypal_email_text=$_POST['paypal_email_text'];
echo $customer_email = $_POST['customer_email'];
 
$mail->Username = "yourcloudcampus@isracom.co.uk";
...
echo $paypal_email_text=$_POST['paypal_email_text'];
echo $customer_email = $_POST['customer_email'];
echo $ccms_user_email = $_POST['ccms_user_email'];
...
$mail->FromName = "YourCloudCampus/Taleem e Quran";
...
$mail->addBCC($ccms_user_email,"CCMS USER Email");

//Student email to whom to send the lecture
$mail->addAddress($customer_email,"User 2");
 
$mail->Subject = "PAYPAL INVOICE - From YourCloudCampus";
$mail->Body = "<div align='center'>Dear Customer,<br><u>Invoice Details are as following</u>
				</div>".$paypal_email_text;
