...
$mail->FromName = "CCMS YourCloudCampus";
...
$mail->addBCC("hashmi@yourcloudcampus.com","Commette Email");

//Student email to whom to send the lecture
$mail->addAddress($student_email,"User 2");
 
$mail->Subject = "Student Lecture Details(Auto Email) - From YourCloudCampus";
$mail->Body = "Dear Parents/Gaurdians , <br>".$letter_format;
